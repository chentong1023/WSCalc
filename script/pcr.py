...
class Yuni(Character):
    def attack_phase(self, env):
        env.top_check_remove_climax(3)
        env, _ = self.attack(env)
        return env

class PCR(Base_Series):
    def __init__(self, soul1, soul2, tot_trig):
        self.ch1 = Yuni(soul_point=3, soul1=soul1, soul2=soul2, tot_trig=tot_trig, direct_attack=0)
        self.ch2 = Yuni(soul_point=3, soul1=soul1, soul2=soul2, tot_trig=tot_trig, direct_attack=0)
        self.ch3 = Yuni(soul_point=3, soul1=soul1, soul2=soul2, tot_trig=tot_trig, direct_attack=0)
...
def main():
    ...
    plt.title("[PCR]3 Yuni")
    plt.savefig("../fig/pcr.png")
    plt.show()
